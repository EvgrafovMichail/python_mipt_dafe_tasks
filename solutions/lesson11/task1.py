...
class Vector2D:
    ...
    def __eq__(self, other : "Vector2D") -> bool:
        ...
        if math.isclose(self.abscissa,other.abscissa) and math.isclose(self.ordinate,other.ordinate):
            return True 
        else:
            return False
    ...
    def __ge__(self, other : "Vector2D") -> bool:
        ...
        if self.abscissa > other.abscissa: 
            return True
        elif math.isclose(self.abscissa, other.abscissa) and (math.isclose(self.ordinate,other.ordinate) or self.ordinate>other.ordinate):
            return True
        else:
            return False
