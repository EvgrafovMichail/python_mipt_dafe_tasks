...
class Vector2D:
    ...
    def __eq__(self, other: "Vector2D") -> bool:
        return (math.isclose(self._abscissa, other._abscissa) and 
                math.isclose(self._ordinate, other._ordinate) )

    def __lt__(self, other: "Vector2D") -> bool:
        return (self._abscissa < other._abscissa or
                self._abscissa == other._abscissa and self._ordinate < other._ordinate)
