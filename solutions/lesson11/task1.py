...
class Vector2D:
    ...
    def __eq__(self, other):
        ...
        return isclose(self.abscissa, other.abscissa, rel_tol=1e-9, abs_tol=1e-10) and isclose(self.ordinate, other.ordinate,  rel_tol=1e-9, abs_tol=1e-10)
    def __lt__(self, other):
        if not isinstance(other, Vector2D):
            return NotImplemented
        return (((self.abscissa < other.abscissa and not(isclose(self.abscissa, other.abscissa, rel_tol=1e-9, abs_tol=1e-10)))
                  or (isclose(self.abscissa, other.abscissa, rel_tol=1e-9, abs_tol=1e-10)
                       and self.ordinate < other.ordinate and not(isclose(self.ordinate, other.ordinate)))
                       ))
