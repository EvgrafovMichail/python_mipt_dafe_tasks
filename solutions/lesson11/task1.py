...
class Vector2D:
    ...
    def __eq__(self, other: Vector2D):
        if not isinstance(other, Vector2D):
            return False  
        return math.isclose(self.abscissa, other.abscissa) and math.isclose(self.ordinate, other.ordinate)
    ...
    def __bool__(self):
        return not (math.isclose(self.ordinate, 0.0, abs_tol=1e-10) and math.isclose(self.abscissa, 0.0, abs_tol=1e-10))
